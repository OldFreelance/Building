<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="Building.Account.Login" %>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:Label ID="RememberMeLabel" runat="server" AssociatedControlID="RememberMe" CssClass="inline">Запомнить</asp:Label>
                    </p>
                </fieldset>
